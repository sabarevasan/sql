...
SELECT product_id, product_name,  
CASE product_qty_type WHEN 'unit' THEN 'unit' ELSE 'bulk' END AS prod_qty_type_condensed,
CASE WHEN product_name LIKE '%pepper%' THEN '1' ELSE '0' END pepper_flag 
FROM product;
...
SELECT * 
FROM vendor V
INNER JOIN vendor_booth_assignments VBA ON V.vendor_id = VBA.vendor_id ORDER BY vendor_name, market_date; 